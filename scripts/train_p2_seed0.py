...
协议输出 outputs/paper-v1/dfire/p2/seed0/，跑完归档到 experiments/yolo11n/D-Fire_p2_seed0/。

运行: python scripts/train_p2_seed0.py              # 训练
      python scripts/train_p2_seed0.py --dry-run    # 只预览检查与命令
"""
import sys
