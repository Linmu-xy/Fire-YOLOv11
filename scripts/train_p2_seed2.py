...
协议输出 outputs/paper-v1/dfire/p2/seed2/，跑完归档到 experiments/yolo11n/D-Fire_p2_seed2/。

运行: python scripts/train_p2_seed2.py              # 训练
      python scripts/train_p2_seed2.py --dry-run    # 只预览检查与命令
"""
import sys
